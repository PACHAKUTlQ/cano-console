# CanoKey Documentation Streamlined

## Glossary

- **WebAuthn**: Its device-side implementations include CTAP 2.1/2.0 protocols.
- **Passkey**: CanoKey can store Passkey keys through the CTAP protocol.
- **OpenPGP**: CanoKey supports all mandatory features in OpenPGP 3.4.1.
- **PIV**: CanoKey supports all mandatory and some extended features of the PIV standard.
- **NDEF**: CanoKey supports emulation of NFC tags compliant with the NDEF format.
- **OTP**: CanoKey supports storing keys for both HOTP and TOTP.
- **WebUSB**: CanoKey supports configuration via WebUSB.
...
CanoKey supports viewing PIV metadata.
